...
{
template <typename T>
struct normalize_funcptr;

template <typename T, typename R , typename ...Args>
struct normalize_funcptr<R (T::*)(Args...) const volatile>
{
    typedef R (T::*type)(Args...);
};

template <typename R , typename ...Args>
struct normalize_funcptr<R (*)(Args...)>
{
    typedef R (*type)(Args...);
};

template <typename T, typename R , typename ...Args>
struct normalize_funcptr<R (T::*)(Args...) const>
{
    typedef R (T::*type)(Args...);
};

template <typename T, typename R , typename ...Args>
struct normalize_funcptr<R (T::*)(Args...) volatile>
{
    typedef R (T::*type)(Args...);
};

template <typename T, typename R , typename ...Args>
struct normalize_funcptr<R (T::*)(Args...)>
{
    typedef R (T::*type)(Args...);
};

template <typename T>
using normalize_funcptr_t = typename normalize_funcptr<T>::type;
...
#define WRAP_FUNCTION_BASE(FTYPE, FNAME, ALIAS) \
    static PowerFake::Wrapper<PowerFake::internal::normalize_funcptr_t<FTYPE>> ALIAS(#ALIAS, reinterpret_cast<PowerFake::internal::normalize_funcptr_t<FTYPE>>(static_cast<FTYPE>(&FNAME)), #FNAME); \
    ...
    template class wrapper_##ALIAS<PowerFake::internal::normalize_funcptr_t<FTYPE>>;
