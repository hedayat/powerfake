...
#define WRAP_FUNCTION(...) \
    PFK_SELECT_9TH(__VA_ARGS__, \
        ...
        WRAP_FUNCTION_2, WRAP_FUNCTION_1)(WRAPPED, __VA_ARGS__)
 ...
 */
#define WRAP_FUNCTION_BASE(FSIG, FNAME, FADDR, ALIAS, FAKE_TYPE, ...) \
...
#define WRAP_PRIVATE_BASE(FSIG, FNAME, ALIAS, FAKE_TYPE, ...) \
 ...
 */
#define WRAP_PRIVATE_MEMBER_IMPL(FSIG, FNAME, ALIAS, FAKE_TYPE, ...) \
    TAG_PRIVATE(PRIVATE_TAG(ALIAS), FNAME); \
    WRAP_PRIVATE_BASE(FSIG, FNAME, ALIAS, FAKE_TYPE __VA_OPT__(,) __VA_ARGS__)

#define WRAP_PRIVATE_MEMBER_IMPL_2(FSIG, FNAME, ALIAS, FAKE_TYPE, ...) \
 ...
 */
#define WRAP_PRIVATE_MEMBER_2_BASE(FAKE_TYPE, FSIG, FNAME, ...) \
    WRAP_PRIVATE_MEMBER_IMPL_2(FSIG, FNAME, \
 ...
 */
#define WRAP_PRIVATE_MEMBER_1_BASE(FAKE_TYPE, FNAME, ...) \
    WRAP_PRIVATE_MEMBER_1_BASE_HELPER(FNAME, \
        PFK_BUILD_NAME(POWRFAKE_WRAP_NAMESPACE, _alias_, __LINE__), FAKE_TYPE \
        __VA_OPT__(,) __VA_ARGS__)

#define WRAP_PRIVATE_MEMBER_1_BASE_HELPER(FNAME, ALIAS, FAKE_TYPE, ...) \
 ...
 */
#define WRAP_FUNCTION_2(FAKE_TYPE, FSIG, FNAME, ...) \
 ...
 */
#define WRAP_FUNCTION_1(FAKE_TYPE, FNAME, ...) \
    WRAP_FUNCTION_2(FAKE_TYPE, decltype(&FNAME), FNAME __VA_OPT__(,) __VA_ARGS__)

/**
 * Define a wrapper for static member function of class FCLASS with type
 * FSIG and name FNAME.
 */
#define WRAP_STATIC_MEMBER_2(FAKE_TYPE, FSIG, FCLASS, FNAME, _1) \
    WRAP_FUNCTION_2(FAKE_TYPE, FSIG, FNAME, FCLASS)

/**
 * Define a wrapper for static member function FNAME of class FCLASS.
 */
#define WRAP_STATIC_MEMBER_1(FAKE_TYPE, FCLASS, FNAME, _1) \
    WRAP_FUNCTION_1(FAKE_TYPE, FNAME, FCLASS)

/**
 * Define a wrapper for private member function with type FSIG and name FNAME
 */
#define WRAP_PRIVATE_MEMBER_2(FAKE_TYPE, FSIG, FNAME, ...) \
    WRAP_PRIVATE_MEMBER_2_BASE(FAKE_TYPE, FSIG, FNAME)

/**
 * Define a wrapper for private member function with name FNAME
 */
#define WRAP_PRIVATE_MEMBER_1(FAKE_TYPE, FNAME, ...) WRAP_PRIVATE_MEMBER_1_BASE(FAKE_TYPE, FNAME)

/**
 * Define a wrapper for static private member function of class FCLASS with
 * type FSIG and name FNAME
 */
#define WRAP_STATIC_PRIVATE_MEMBER_2(FAKE_TYPE, FCLASS, FSIG, FNAME, ...) \
    WRAP_PRIVATE_MEMBER_2_BASE(FAKE_TYPE, FSIG, FNAME, FCLASS)
